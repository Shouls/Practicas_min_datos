...
#plt.show()
plt.savefig('.././PollutionSK/imgs/regresion_lineal/regresion_lineal_co_Bangsan-Myeon.jpg')
plt.close('all')
b = reg.intercept_
m = reg.coef_
...
plt.xlabel("Fechas")
plt.xticks(df_bm0["date_num"].values - 735234, df_bm0["date"].values, rotation = 90)
plt.savefig('.././PollutionSK/imgs/regresion_lineal/Forecasting_co_Bangsan-Myeon.jpg')
